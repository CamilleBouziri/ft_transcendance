...
from .views import rechercher_utilisateur, envoyer_demande_ami, amis, accepter_demande_ami, refuser_demande_ami, supprimer_ami, get_friends_status, get_friend_requests, get_pending, get_friends
